...
class AudioControls extends Component {
  ...
  renderVideo() {
    return (<View style={styles.videoContainer}>
      <Video source={{
          uri: 'http://www.podcastgenerator.net/demoV2/pg/media/2016-08-13_video3dprinters.mp4'
        }}
  ...
  renderRadioMini() {
    const {currentTime, duration, currentAudio} = this.state;
    return (<View style={styles.playerResize}>
      <View style={styles.detailLeft}>
        ...
        <Image source={currentAudio.thumbnailUri
            ...
            : currentAudio.thumbnailLocal} style={{
            width: 48,
            height: 48,
            borderRadius: 48 / 2
          }}/>
